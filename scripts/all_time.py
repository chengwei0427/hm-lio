...
#   取第一行所有的字符串
data0 = [line.strip() for line in data if line.strip() and line.startswith('fov segment')]
...
#   从第二行开始，读取所有数据
data = [line.strip() for line in data if line.strip() and not line.startswith('fov segment')]
